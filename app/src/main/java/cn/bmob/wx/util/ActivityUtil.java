...
import cn.bmob.wx.ui.SplashActivity;
...
public final class ActivityUtil {
    ...
    public static int[] getScreenSize() {
        ...
        dm= BmobIMApplication.getInstance().getResources().getDisplayMetrics();
    ...
    public static void show(final Context context, final String message) {
        final String msg=msgFilter != null ? msgFilter.filter(message) : message;
        BmobIMApplication.getInstance().getTopActivity().runOnUiThread(new Runnable() {

            public void run() {
                // Toast.makeText(activity, msg, Toast.LENGTH_SHORT).show();
                Toast toast=ToastFactory.getToast(BmobIMApplication.getInstance().getTopActivity(), message);
...
//    }
    ...
    public static String getImei(Context context) {
        ...
        LogUtils.d("IMEI", tm.getDeviceId());
