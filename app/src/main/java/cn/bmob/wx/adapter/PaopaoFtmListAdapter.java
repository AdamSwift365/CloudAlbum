...
import cn.bmob.wx.ui.MainActivity;
import cn.bmob.wx.ui.PhotoActivity;
import cn.bmob.wx.ui.view.CircleImageView;
import cn.bmob.wx.util.DisplayConfig;
import cn.bmob.wx.util.LogUtils;
import cn.bmob.wx.util.TimeUtil;
...
public class PaopaoFtmListAdapter extends BaseAdapter {
    ...
    public PaopaoFtmListAdapter(Context context, List<Paopao> list, ImageLoader imageLoader){
        ...
        this.options = DisplayConfig.getOptionsById(R.drawable.user_icon_default_main) ;
            ...
            viewHolder.contentImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(
                            (MainActivity)(viewHolder.contentImage.getRootView().getContext())
                            , PhotoActivity.class);
